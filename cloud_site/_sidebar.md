- <a href="#/plan" data-route="#/plan" class="toc-subject-link">今日计划</a>
  - <span class="toc-date-row"><button type="button" class="toc-toggle" data-toggle-anchor="plan-section-01" aria-label="展开或收起 数学（共 2 道 / 上限 8）">›</button><a href="#/plan" data-anchor="plan-section-01" class="toc-date-link">数学（共 2 道 / 上限 8）</a></span>
    - <a href="#/plan" data-anchor="plan-section-01-01" class="toc-problem-link">错题 02（06-19）</a>
    - <a href="#/plan" data-anchor="plan-section-01-02" class="toc-problem-link">错题 03（06-19）</a>
