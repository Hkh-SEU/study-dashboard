...
- 首页只作为学习入口：最近发布时间、今日复习摘要、三个复习入口。
- 手机端底部有固定导航，可以快速切换：`首页`、`计划`、`数学`、`专业课`。
- 文档页顶部有快捷导航，可以直接切换：`首页`、`今日计划`、`数学`、`专业课`。
- 数学错题本和专业课错题本会自动生成“本页目录”，可以按日期和错题编号跳转。
- 文档顶部默认只显示更新时间，来源路径等信息收进“发布详情”。
- 错题截图可以点击打开原图，方便在手机上双指缩放查看，图片下方会提示“点击图片查看原图”。
